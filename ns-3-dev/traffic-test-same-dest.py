...
if __name__=="__main__":
    ...
    source_dest_choices = random.sample(filter(lambda n: n != random_dest, nodes), perc)
    source_dest_pairs = ','.join(map(lambda e:'='.join(map(str, [e, random_dest])), source_dest_choices))
