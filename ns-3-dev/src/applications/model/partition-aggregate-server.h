 ...
 * \defgroup packetsink PartitionAggregateServer
 *
 * This application was written to complement OnOffApplication, but it
 * is more general so a PartitionAggregateServer name was selected.  Functionally it is
...
public:
  ...
  static const uint32_t RESPONSE_SIZE = 2048;
